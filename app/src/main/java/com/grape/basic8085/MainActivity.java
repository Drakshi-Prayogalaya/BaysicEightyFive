...
import com.grape.basic8085.fragment.AboutUsFragment;
import com.grape.basic8085.fragment.ExperimentsFragment;
import com.grape.basic8085.fragment.HomeFragment;
        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        AdBuddiz.setPublisherKey("0ce2b20e-7686-49b9-b4ca-74c4260feaed");
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        else if (id == R.id.menu_share)
        {
            ...
            intent.putExtra(Intent.EXTRA_TEXT, "Hello friends!!! Check out this application in play store. \"Basic 8085\" - https://play.google.com/store/apps/details?id=com.grape.basic8085");
        ...
        else if (id == R.id.menu_rate_the_app)
        {
            closeDrawerLayout();
            Intent intent = new Intent(Intent.ACTION_VIEW);
            intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.grape.basic8085"));
            startActivity(intent);
        }
